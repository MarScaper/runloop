...
RunLoopInterruptPin12::RunLoopInterruptPin12(uint8_t inputMode,int interruptMode)
{
  __interruptInstance = this;

  pinMode(12, inputMode);
  
  _attachInterrupt(digitalPinToInterrupt(12), interruptServiceRoutine, interruptMode);
}

RunLoopInterruptPin12::~RunLoopInterruptPin12()
{
