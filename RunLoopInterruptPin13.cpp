...
RunLoopInterruptPin13::RunLoopInterruptPin13(uint8_t inputMode,int interruptMode)
{
  __interruptInstance = this;

  pinMode(13, inputMode);
  
  _attachInterrupt(digitalPinToInterrupt(13), interruptServiceRoutine, interruptMode);
}

RunLoopInterruptPin13::~RunLoopInterruptPin13()
{
