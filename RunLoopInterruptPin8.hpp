 ...
 */
#ifndef RunLoopInterruptPin8_hpp
#define RunLoopInterruptPin8_hpp
...
/*!
 * The class manages interrupts on pin 8 of the Arduino.
 *
 *  @ingroup Model
 */
class RunLoopInterruptPin8 : public RunLoopInterrupt
{
...
#pragma mark Create and destroy
   ...
   */
  RunLoopInterruptPin8(uint8_t inputMode,int interruptMode);
