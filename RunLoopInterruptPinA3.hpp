 ...
 */
#ifndef RunLoopInterruptPinA3_hpp
#define RunLoopInterruptPinA3_hpp
...
/*!
 * The class manages interrupts on pin 0 of the Arduino.
 *
 *  @ingroup Model
 */
class RunLoopInterruptPinA3 : public RunLoopInterrupt
{
...
#pragma mark Create and destroy
   ...
   */
  RunLoopInterruptPinA3(uint8_t inputMode,int interruptMode);
