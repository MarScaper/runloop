...
RunLoopInterruptPinA1::RunLoopInterruptPinA1(uint8_t inputMode,int interruptMode)
{
  __interruptInstance = this;

  pinMode(A1, inputMode);
  
  _attachInterrupt(digitalPinToInterrupt(A1), interruptServiceRoutine, interruptMode);
}

RunLoopInterruptPinA1::~RunLoopInterruptPinA1()
{
