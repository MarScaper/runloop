...
RunLoopInterruptPin2::RunLoopInterruptPin2(uint8_t inputMode,int interruptMode)
{
  __interruptInstance = this;

  pinMode(2, inputMode);
  
  _attachInterrupt(digitalPinToInterrupt(2), interruptServiceRoutine, interruptMode);
}

RunLoopInterruptPin2::~RunLoopInterruptPin2()
{
