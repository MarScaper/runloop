 ...
 */
#ifndef RunLoopInterruptPin7_hpp
#define RunLoopInterruptPin7_hpp
...
/*!
 * The class manages interrupts on pin 7 of the Arduino.
 *
 *  @ingroup Model
 */
class RunLoopInterruptPin7 : public RunLoopInterrupt
{
...
#pragma mark Create and destroy
   ...
   */
  RunLoopInterruptPin7(uint8_t inputMode,int interruptMode);
