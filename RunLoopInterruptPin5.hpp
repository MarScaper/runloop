 ...
 */
#ifndef RunLoopInterruptPin5_hpp
#define RunLoopInterruptPin5_hpp
...
/*!
 * The class manages interrupts on pin 5 of the Arduino.
 *
 *  @ingroup Model
 */
class RunLoopInterruptPin5 : public RunLoopInterrupt
{
...
#pragma mark Create and destroy
   ...
   */
  RunLoopInterruptPin5(uint8_t inputMode,int interruptMode);
