 ...
 */
#ifndef RunLoopInterruptPinA1_hpp
#define RunLoopInterruptPinA1_hpp
...
/*!
 * The class manages interrupts on pin A1 of the Arduino.
 *
 *  @ingroup Model
 */
class RunLoopInterruptPinA1 : public RunLoopInterrupt
{
...
#pragma mark Create and destroy
   ...
   */
  RunLoopInterruptPinA1(uint8_t inputMode,int interruptMode);
