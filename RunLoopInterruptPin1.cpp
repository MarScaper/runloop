...
RunLoopInterruptPin1::RunLoopInterruptPin1(uint8_t inputMode,int interruptMode)
{
  __interruptInstance = this;

  pinMode(1, inputMode);
  
  _attachInterrupt(digitalPinToInterrupt(1), interruptServiceRoutine, interruptMode);
}

RunLoopInterruptPin1::~RunLoopInterruptPin1()
{
