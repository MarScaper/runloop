 ...
 */
#ifndef RunLoopInterruptPin3_hpp
#define RunLoopInterruptPin3_hpp
...
/*!
 * The class manages interrupts on pin 3 of the Arduino.
 *
 *  @ingroup Model
 */
class RunLoopInterruptPin3 : public RunLoopInterrupt
{
...
#pragma mark Create and destroy
   ...
   */
  RunLoopInterruptPin3(uint8_t inputMode,int interruptMode);
