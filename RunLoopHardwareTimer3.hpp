 ...
 */
#ifndef RunLoopHardwareTimer3_hpp
#define RunLoopHardwareTimer3_hpp
...
/*!
 * The class manages the hardware Timer3 (16bits) available with the <b>Arduino Mega only</b>.
 ...
 *  @ingroup Model
 */
class RunLoopHardwareTimer3 : public RunLoopHardwareTimer
{
