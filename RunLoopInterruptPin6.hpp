 ...
 */
#ifndef RunLoopInterruptPin6_hpp
#define RunLoopInterruptPin6_hpp
...
/*!
 * The class manages interrupts on pin 6 of the Arduino.
 *
 *  @ingroup Model
 */
class RunLoopInterruptPin6 : public RunLoopInterrupt
{
...
#pragma mark Create and destroy
   ...
   */
  RunLoopInterruptPin6(uint8_t inputMode,int interruptMode);
