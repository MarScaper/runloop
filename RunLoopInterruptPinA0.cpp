...
RunLoopInterruptPinA0::RunLoopInterruptPinA0(uint8_t inputMode,int interruptMode)
{
  __interruptInstance = this;

  pinMode(A0, inputMode);
  
  _attachInterrupt(digitalPinToInterrupt(A0), interruptServiceRoutine, interruptMode);
}

RunLoopInterruptPinA0::~RunLoopInterruptPinA0()
{
