...
RunLoopInterruptPinA2::RunLoopInterruptPinA2(uint8_t inputMode,int interruptMode)
{
  __interruptInstance = this;

  pinMode(A2, inputMode);
  
  _attachInterrupt(digitalPinToInterrupt(A2), interruptServiceRoutine, interruptMode);
}

RunLoopInterruptPinA2::~RunLoopInterruptPinA2()
{
