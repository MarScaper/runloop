...
RunLoopInterruptPin5::RunLoopInterruptPin5(uint8_t inputMode,int interruptMode)
{
  __interruptInstance = this;

  pinMode(5, inputMode);
  
  _attachInterrupt(digitalPinToInterrupt(5), interruptServiceRoutine, interruptMode);
}

RunLoopInterruptPin5::~RunLoopInterruptPin5()
{
