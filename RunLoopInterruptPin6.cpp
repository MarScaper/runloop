...
RunLoopInterruptPin6::RunLoopInterruptPin6(uint8_t inputMode,int interruptMode)
{
  __interruptInstance = this;

  pinMode(6, inputMode);
  
  _attachInterrupt(digitalPinToInterrupt(6), interruptServiceRoutine, interruptMode);
}

RunLoopInterruptPin6::~RunLoopInterruptPin6()
{
