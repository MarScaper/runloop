 ...
 */
#ifndef RunLoopInterruptPin2_hpp
#define RunLoopInterruptPin2_hpp
...
/*!
 * The class manages interrupts on pin 2 of the Arduino.
 *
 *  @ingroup Model
 */
class RunLoopInterruptPin2 : public RunLoopInterrupt
{
...
#pragma mark Create and destroy
  ...
  RunLoopInterruptPin2(uint8_t inputMode,int interruptMode);
