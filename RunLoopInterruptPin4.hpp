 ...
 */
#ifndef RunLoopInterruptPin4_hpp
#define RunLoopInterruptPin4_hpp
...
/*!
 * The class manages interrupts on pin 4 of the Arduino.
 *
 *  @ingroup Model
 */
class RunLoopInterruptPin4 : public RunLoopInterrupt
{
...
#pragma mark Create and destroy
   ...
   */
  RunLoopInterruptPin4(uint8_t inputMode,int interruptMode);
