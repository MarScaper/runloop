...
RunLoopInterruptPin3::RunLoopInterruptPin3(uint8_t inputMode,int interruptMode)
{
  __interruptInstance = this;

  pinMode(3, inputMode);
  
  _attachInterrupt(digitalPinToInterrupt(3), interruptServiceRoutine, interruptMode);
}

RunLoopInterruptPin3::~RunLoopInterruptPin3()
{
