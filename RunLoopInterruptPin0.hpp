 ...
 */
#ifndef RunLoopInterruptPin0_hpp
#define RunLoopInterruptPin0_hpp
 ...
 *  @ingroup Model
 */
class RunLoopInterruptPin0 : public RunLoopInterrupt
{
...
#pragma mark Create and destroy
   ...
   */
  RunLoopInterruptPin0(uint8_t inputMode,int interruptMode);
