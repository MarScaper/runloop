 ...
 */
#ifndef RunLoopInterruptPin9_hpp
#define RunLoopInterruptPin9_hpp
...
/*!
 * The class manages interrupts on pin 9 of the Arduino.
 *
 *  @ingroup Model
 */
class RunLoopInterruptPin9 : public RunLoopInterrupt
{
...
#pragma mark Create and destroy
   ...
   */
  RunLoopInterruptPin9(uint8_t inputMode,int interruptMode);
