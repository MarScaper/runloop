...
RunLoopInterruptPinA5::RunLoopInterruptPinA5(uint8_t inputMode,int interruptMode)
{
  __interruptInstance = this;

  pinMode(A5, inputMode);
  
  _attachInterrupt(digitalPinToInterrupt(A5), interruptServiceRoutine, interruptMode);
}

RunLoopInterruptPinA5::~RunLoopInterruptPinA5()
{
