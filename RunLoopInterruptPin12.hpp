 ...
 */
#ifndef RunLoopInterruptPin12_hpp
#define RunLoopInterruptPin12_hpp
...
/*!
 * The class manages interrupts on pin 12 of the Arduino.
 *
 *  @ingroup Model
 */
class RunLoopInterruptPin12 : public RunLoopInterrupt
{
...
#pragma mark Create and destroy
   ...
   */
  RunLoopInterruptPin12(uint8_t inputMode,int interruptMode);
