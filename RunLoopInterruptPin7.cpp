...
RunLoopInterruptPin7::RunLoopInterruptPin7(uint8_t inputMode,int interruptMode)
{
  __interruptInstance = this;

  pinMode(7, inputMode);
  
  _attachInterrupt(digitalPinToInterrupt(7), interruptServiceRoutine, interruptMode);
}

RunLoopInterruptPin7::~RunLoopInterruptPin7()
{
