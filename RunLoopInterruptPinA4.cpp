...
RunLoopInterruptPinA4::RunLoopInterruptPinA4(uint8_t inputMode,int interruptMode)
{
  __interruptInstance = this;

  pinMode(A4, inputMode);
  
  _attachInterrupt(digitalPinToInterrupt(A4), interruptServiceRoutine, interruptMode);
}

RunLoopInterruptPinA4::~RunLoopInterruptPinA4()
{
