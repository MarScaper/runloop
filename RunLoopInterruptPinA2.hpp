 ...
 */
#ifndef RunLoopInterruptPinA2_hpp
#define RunLoopInterruptPinA2_hpp
...
/*!
 * The class manages interrupts on pin A2 of the Arduino.
 *
 *  @ingroup Model
 */
class RunLoopInterruptPinA2 : public RunLoopInterrupt
{
...
#pragma mark Create and destroy
   ...
   */
  RunLoopInterruptPinA2(uint8_t inputMode,int interruptMode);
