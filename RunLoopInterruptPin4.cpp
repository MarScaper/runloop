...
RunLoopInterruptPin4::RunLoopInterruptPin4(uint8_t inputMode,int interruptMode)
{
  __interruptInstance = this;

  pinMode(4, inputMode);
  
  _attachInterrupt(digitalPinToInterrupt(4), interruptServiceRoutine, interruptMode);
}

RunLoopInterruptPin4::~RunLoopInterruptPin4()
{
