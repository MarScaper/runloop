...
RunLoopInterruptPin8::RunLoopInterruptPin8(uint8_t inputMode,int interruptMode)
{
  __interruptInstance = this;

  pinMode(8, inputMode);
  
  _attachInterrupt(digitalPinToInterrupt(8), interruptServiceRoutine, interruptMode);
}

RunLoopInterruptPin8::~RunLoopInterruptPin8()
{
