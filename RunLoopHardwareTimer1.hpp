 ...
 */
#ifndef RunLoopHardwareTimer1_hpp
#define RunLoopHardwareTimer1_hpp
...
/*!
 * The class manages the hardware Timer1 (16bits) of the arduino.
 ...
 *  @ingroup Model
 */
class RunLoopHardwareTimer1 : public RunLoopHardwareTimer
{
