 ...
 */
#ifndef RunLoopHardwareTimer4_hpp
#define RunLoopHardwareTimer4_hpp
...
/*!
 * The class manages the hardware Timer4 (16bits) available with the <b>Arduino Mega only</b>.
 ...
 *  @ingroup Model
 */
class RunLoopHardwareTimer4 : public RunLoopHardwareTimer
{
