 ...
 */
#ifndef RunLoopInterruptPinA0_hpp
#define RunLoopInterruptPinA0_hpp
...
/*!
 * The class manages interrupts on pin A0 of the Arduino.
 *
 *  @ingroup Model
 */
class RunLoopInterruptPinA0 : public RunLoopInterrupt
{
...
#pragma mark Create and destroy
   ...
   */
  RunLoopInterruptPinA0(uint8_t inputMode,int interruptMode);
